...
public class Abonements {
    ...
    double summa = Lietotaji.getCurrentUserBalance();  // New: Get current user's balance
        ...
        case 1:
            ...
            if (iegadatiesIzvele == 1) {
                ...
                if (summa >= paymentAmount) {
                    summa -= paymentAmount;  // Deduct payment
                    Lietotaji.updateCurrentUserBalance(summa);  // New: Update balance
